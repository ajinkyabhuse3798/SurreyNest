...
def upgrade() -> None:
    ...
    op.add_column('properties', sa.Column('construction_age_band', sa.String(length=50), nullable=True))
    op.add_column('properties', sa.Column('mains_gas_flag', sa.Integer(), nullable=True))
    op.add_column('properties', sa.Column('floor_level', sa.Integer(), nullable=True))
    op.add_column('properties', sa.Column('annual_energy_cost', sa.Float(), nullable=True))
