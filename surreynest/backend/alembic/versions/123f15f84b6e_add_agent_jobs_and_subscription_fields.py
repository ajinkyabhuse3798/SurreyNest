"""add_agent_jobs_and_subscription_fields

Revision ID: 123f15f84b6e
Revises: 11c4ed46d4db
Create Date: 2026-03-10 22:54:14.466626
...
revision: str = '123f15f84b6e'
down_revision: Union[str, None] = '11c4ed46d4db'
...
def upgrade() -> None:
    ...
    op.add_column('users', sa.Column('agent_credits', sa.Integer(), server_default='0', nullable=False))
...
def downgrade() -> None:
    ...
    op.drop_column('users', 'agent_credits')
