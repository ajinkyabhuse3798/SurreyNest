...
def upgrade() -> None:
    op.add_column('reviews', sa.Column('agent_name', sa.String(length=255), nullable=True))
    op.create_index(op.f('ix_reviews_agent_name'), 'reviews', ['agent_name'], unique=False)
