"""add_is_university_managed

Revision ID: 40b58f8feae3
Revises: 3d35dbcf5fdf
Create Date: 2026-03-09 22:23:54.681005
...
revision: str = '40b58f8feae3'
down_revision: Union[str, None] = '3d35dbcf5fdf'
...
def upgrade() -> None:
    ...
    op.add_column('properties', sa.Column('is_university_managed', sa.Boolean(), nullable=False))
    ...
    op.create_index(op.f('ix_properties_is_university_managed'), 'properties', ['is_university_managed'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_properties_is_university_managed'), table_name='properties')
