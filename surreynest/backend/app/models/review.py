...
class Review(Base):
    ...
    Attributes:
        ...
        landlord_rating: 1–5 — landlord responsiveness and professionalism.
        condition_rating: 1–5 — property condition and maintenance.
        value_rating: 1–5 — rent value for money.
    ...
    __table_args__ = (
        ...
        # Enforce 1–5 star range on all rating columns
