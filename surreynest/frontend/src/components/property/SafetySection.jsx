    ...
    return (
        <div className="space-y-6">
            ...
            <Link
                ...
                className="group relative overflow-hidden flex items-center gap-4 bg-gradient-to-br from-primary/90 via-primary-800 to-primary-900 hover:from-primary-800 hover:to-primary-800 rounded-2xl px-5 py-4 lg:py-5 border border-primary-700/50 transition-all duration-300 shadow-[0_8px_30px_-4px_rgba(49,46,129,0.3)] hover:shadow-[0_12px_40px_-4px_rgba(49,46,129,0.4)]"
            >
                {/* Glow accent */}
                <div className="absolute -left-12 -top-12 w-32 h-32 bg-primary/100/20 rounded-full blur-2xl group-hover:bg-primary/100/30 transition-colors" />
                ...
                <div className="flex-1 min-w-0 z-10">
                    ...
                    <p className="text-xs text-primary-200 mt-1 font-medium">Crime breakdown, trends & area rankings</p>
                </div>
